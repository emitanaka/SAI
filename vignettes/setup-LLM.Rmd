...
Pull a LLM, say `llama3.1:8b` (see list of models availble [here](https://ollama.com/library)):
...
You need to restart your R session after entering your API key.


Some of the vendors give free access, however there may be some cost involved for particular usages (e.g. commercial).
