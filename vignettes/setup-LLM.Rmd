...
[WIP] User who have difficulty setting up Ollama can alternatively register an account with an AI vendor listed [below](#api). There may payments involved for continued usage from these vendors. 
